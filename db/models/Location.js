...
module.exports = (sequelize, DataTypes) => {
  var Location = sequelize.define('Location', {
    ...
    locationType:  { type: DataTypes.ENUM('USER', 'POSTALCODE', 'LISTING', 'CUSTOM'), field: 'location_type', defaultValue: 'CUSTOM' },  // Probably ENUM. Default is bad here, but makes sense now.
