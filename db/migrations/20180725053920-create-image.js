...
module.exports = {
  up: function(queryInterface, Sequelize) {
    return queryInterface.createTable('Images', {
      ...
      listingId:  { type: Sequelize.INTEGER, field: 'listing_id' },  // TODO? this or user_id MUST not be null
      userId:     { type: Sequelize.INTEGER, field: 'user_id' },  // TODO? this or user_id MUST not be null
