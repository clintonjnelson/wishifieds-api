...
module.exports = class ZipcodeToLocationSqlTransform extends Transform {
  ...
  _transform(chunk, encoding, next) {
    ...
    if(pieces.length > 1) {
      var countryCode = pieces[0].trim() || null;
      var zip = pieces[1].trim() || null;
      var city = pieces[2].trim().replace("'", "''") || null;
      var state = pieces[3].trim() || null;
      var stateCode = pieces[4].trim() || null;
      ...
      var fullSql = "('', " + geoPoint + ", 'POINT', '" + zip + "', '"+ city +"', '" + state +"', '" + stateCode +"', '" + countryCode +"', 'POSTALCODE', '2019-05-09 22:45:33.05+00', '2019-05-09 22:45:33.05+00'), \n";
