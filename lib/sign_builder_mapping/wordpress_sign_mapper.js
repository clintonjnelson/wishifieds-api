...
module.exports = function(signBuilder) {
  ...
  function buildWordpressSign(wpData) {
    ...
    console.log("WORDPRESS DATA IN SIGN MAPPER IS: ", wpData);
    ...
    var signProps = {
        ...
        // ----------------- CUSTOM ---------------------
        profileId:   wpData.profileId, // This IS UNIQUE
        siteId:      wpData.siteId,    // THIS IS NOT UNIQUE! Can be shared among multiple people
