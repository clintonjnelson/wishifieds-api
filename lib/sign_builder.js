...
require('./sign_builder_mapping/generic_sign_mapper.js'       )(builder);   // Generic
require('./sign_builder_mapping/amazon_sign_mapper.js'        )(builder);
...
require('./sign_builder_mapping/patreon_sign_mapper.js'       )(builder);
