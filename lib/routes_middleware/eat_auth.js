'use strict';
// This is the session cookie middleware used to authenticate a user
// Allowed to come in as "eat" via header, body, params or cookieTokens
...
module.exports = function(secret) {
  ...
  return function eatAuth(req, res, next) {
    ...
    var eatToken = req.headers.eat || req.body.eat || req.params.eat || cookieTokens.eat;
    ...
    eatToken = decodeURIComponent(eatToken);

    eat.decode(eatToken, secret, function(err, decoded) {  // token exists, try decoding
      if (err) {
