...
var getStackexchangeInfo    = require('../api_data_requests/stackexchange_api_req.js');
...
module.exports = function(passport) {
  passport.use(new StackexchangeStrategy({
    ...
    callbackURL:  process.env.STACKEXCHANGE_CALLBACK_URL || 'http://127.0.0.1:3000/api/auth/stackexchange/callback',
