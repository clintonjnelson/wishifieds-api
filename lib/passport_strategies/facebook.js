...
module.exports = function(passport) {
  passport.use(new FacebookStrategy({
    ...
    callbackURL:  buildCallbackUrl('facebook') || 'https://localhost:8443/api/validate_credibility/facebook/callback',
...
function getFacebookInfo(accessToken, noIdentifierNeeded, callback) {
  ...
  var apiInfo = {
    ...
    queryString: {fields: 'link'},  // 'email,name,link,picture.width(720)'  // https://developers.facebook.com/docs/facebook-login/permissions/
  };
